...
const whatYouGet = [
    'Qualified meetings with HOA decision makers',
    'Predictable contract opportunities',
    'Zero time spent on outreach or follow-ups',
    'No more quoting for people who can’t sign',
    'Renewing contracts that stabilize revenue',
    'A proven sales process done for you'
];
...
const howItWorks = [
    {
        ...
        text: 'Tell us where you work and the jobs you want most.',
        icon: (
    ...
    },
    {
        ...
        text: 'We find the real decision makers for your market.',
        icon: (
            <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="1.7" viewBox="0 0 24 24">
    ...
    },
    {
        ...
        text: 'We run the calling, emailing, and follow-ups.',
        icon: (
            <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="1.7" viewBox="0 0 24 24">
    ...
    },
    {
        ...
        text: 'You get pre-framed appointments with signers.',
        icon: (
            <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="1.7" viewBox="0 0 24 24">
    ...
    },
    {
        ...
        text: 'You stay in the field while the pipeline stays full.',
        icon: (
            <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="1.7" viewBox="0 0 24 24">
...
const reasonsToChoose = [
    ...
    'Meet real decision makers, not random homeowners',
    'We speak the language of HOAs and property managers',
    'Month-to-month; we earn the renewal',
    'Dedicated outreach without hiring staff'
];
                ...
                <main id="top">
                        ...
                        <div className="mx-auto flex max-w-6xl flex-col gap-10 px-6 pb-20 pt-16 md:flex-row md:items-center md:pt-20">
                            <div className="w-full md:w-3/5">
                                ...
                                <p className="mt-6 max-w-2xl text-lg text-slate-600">
                                    We put qualified HOA decision makers on your calendar so you can stay in the field and grow.
                                </p>
                                ...
                                <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-slate-50 p-8 shadow-sm">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-slate-500">Pipeline clarity at a glance</p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="mt-6 rounded-xl border border-slate-200 bg-white p-4">
                                        ...
                                        <div className="rounded-lg bg-slate-100 px-4 py-3 text-right">
                                            ...
                                            <p className="text-xs text-slate-600">Trending up</p>
                                        </div>
                                        </div>
                                    </div>
                        ...
                        <div className="mx-auto max-w-6xl px-6">
                            <div className="grid gap-10 md:grid-cols-[1.1fr,0.9fr] md:items-center">
                                <div>
                                    ...
                                    <p className="mt-4 text-slate-600">Most vendors miss HOA work because:</p>
                        ...
                        <div className="mx-auto max-w-6xl px-6">
                            <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                                <div>
                                    ...
                                    <p className="mt-3 max-w-2xl text-slate-600">Five quick steps to keep your calendar full.</p>
                                </div>
                                <a
                                    href="#contact"
                        ...
                        <div className="mx-auto max-w-6xl px-6">
                            <div className="grid gap-8 md:grid-cols-[1.1fr,0.9fr] md:items-center">
                                <div>
                                    ...
                                    <p className="mt-8 text-lg font-semibold text-slate-900">Show up to the meeting. Win the contract.</p>
                                </div>
                        ...
                        <div className="mx-auto max-w-6xl px-6">
                            <div className="grid gap-8 md:grid-cols-[1.1fr,0.9fr] md:items-center">
                                <div>
                                    ...
                                    <p className="mt-8 text-lg font-semibold text-slate-900">We book meetings or we’re gone. Simple.</p>
                                </div>
                                <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                                    <div className="rounded-xl border border-slate-200 bg-slate-50 p-6">
                                        <p className="text-sm font-semibold text-slate-800">Want pricing?</p>
                                        <p className="mt-2 text-sm text-slate-600">Book a call and we’ll tailor pricing to your market.</p>
                                        <a
                                            href="#contact"
                        ...
                        <div className="mx-auto max-w-6xl px-6">
                            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                <div>
                                    ...
                                    <p className="mt-3 text-slate-600">Vendors who let us handle outbound.</p>
                                </div>
                                <a
                                    href="#contact"
                                    className={`inline-flex items-center justify-center rounded-full px-5 py-2 text-sm font-semibold text-white transition duration-200 hover:-translate-y-0.5 hover:shadow-md ${accentBg}`}
                    ...
                    <section id="contact" className="bg-white py-16">
                        <div className="mx-auto max-w-6xl px-6">
                            ...
                            <p className="mt-3 max-w-2xl text-slate-600">Tell us where you work and what you need. We’ll handle the outreach.</p>
